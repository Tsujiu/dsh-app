# Magenta Bill / Cartaz magenta

Colorway variant of the bundled Broadside / Manifesto laranja e preto template: the same twelve editable layouts and geometry, rebuilt around wine black with a single hot-magenta accent. The base edition is adapted from Zara Zhang's Broadside, commit e5e204fb1f3b06290846e7dcd7aceddabeceec8c. MIT. This native edition rebuilds 12 editable layouts; it is not an HTML import or an exact copy of every upstream slide.
...
Copyright (c) 2026 Zara Zhang. DSH adaptation 2026-09-06; Magenta Bill colorway variant 2026-09-13. Derived from the bundled Manifesto laranja e preto template (MIT); see its design document for the pinned upstream source.
