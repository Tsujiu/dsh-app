# Slate Journal / Diário ardósia

Colorway variant of the bundled Soft Editorial / Editorial suave template: the same twelve editable layouts and geometry, rebuilt around cool slate paper with muted mineral accents. The base edition is adapted from Zara Zhang's Soft Editorial, commit e5e204fb1f3b06290846e7dcd7aceddabeceec8c. MIT. This native edition rebuilds twelve editable layouts; it is not an HTML import or an exact copy of every upstream slide.
...
## Layout grammar
 ...
 A warm magazine spread aesthetic — the kind of layout a small print quarterly with field-notes pretensions would commission. Cormorant Garamond carries every headline and ornamental moment with mixed roman and italic; Work Sans recedes into supporting body. The palette is slate paper with a quartet of muted mineral accents (dusty blue, pale teal, soft sand, sage, grey-lilac) used as colored card backgrounds. Generous rounded cards (24–36px radius) float on translucent white over the slate field. The mood is editorial calm with a sprinkling of riso-print color — closer to a literary research notebook than a corporate deck.
...
Copyright (c) 2026 Zara Zhang. DSH adaptation 2026-09-06; Slate Journal colorway variant 2026-09-13. Derived from the bundled Editorial suave template (MIT); see its design document for the pinned upstream source.
