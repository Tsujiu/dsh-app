# Crimson Ledger / Livro-caixa carmesim

Colorway variant of the bundled Blue Professional / Negócios azuis template: the same twelve editable layouts and geometry, rebuilt around warm ivory with a single deep-crimson accent. The base edition is adapted from Zara Zhang's Blue Professional, commit e5e204fb1f3b06290846e7dcd7aceddabeceec8c. MIT. This native edition rebuilds 12 editable layouts; it is not an HTML import or an exact copy of every upstream slide.
...
Use evidence-led report compositions: an executive thesis beside supporting evidence, stacked trends with annotations, a contribution bridge, a portfolio matrix, a customer journey, a capability architecture, a case comparison, a dependency roadmap, and a decision table. Keep ivory as the field and use crimson to identify the decision or most important series.
...
Copyright (c) 2026 Zara Zhang. DSH adaptation 2026-09-06; Crimson Ledger colorway variant 2026-09-13. Derived from the bundled Negócios azuis template (MIT); see its design document for the pinned upstream source.
