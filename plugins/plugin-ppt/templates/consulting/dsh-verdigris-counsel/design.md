# Verdigris Counsel / Decisão verde-pátina

Colorway variant of the bundled Signal / Decisão azul-marinho template: the same twelve editable layouts and geometry, rebuilt around deep pine with a single verdigris-green accent. The base edition is adapted from Zara Zhang's Signal, commit e5e204fb1f3b06290846e7dcd7aceddabeceec8c. MIT. This native edition rebuilds twelve editable layouts; it is not an HTML import or an exact copy of every upstream slide.
...
## Layout grammar
 ...
 A literary editorial presentation system in the spirit of a long-form magazine — The Economist's restraint crossed with a private intelligence briefing. Source Serif 4 carries every headline with roman/italic mixing mid-sentence in verdigris green, DM Sans steps back for body, and IBM Plex Mono runs all the timestamps, kickers, and chrome. The dual surface system is pale pine paper (#26332F) and deep pine (#17211F), connected by a single hot accent — verdigris green (#6FAE9C) — used only on rules, italic emphasis, and numerical figures. A near-invisible 80px grid texture overlays every dark slide as a fingerprint. The effect is sober, considered, and a little bit aristocratic.
...
Copyright (c) 2026 Zara Zhang. DSH adaptation 2026-09-06; Verdigris Counsel colorway variant 2026-09-13. Derived from the bundled Decisão azul-marinho template (MIT); see its design document for the pinned upstream source.
