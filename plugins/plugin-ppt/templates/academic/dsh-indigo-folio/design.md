# Indigo Folio / Periódico índigo

Colorway variant of the bundled Monochrome / Pesquisa minimalista template: the same twelve editable layouts and geometry, rebuilt as deep indigo ink on cool ivory paper. The base edition is adapted from Zara Zhang's Monochrome, commit e5e204fb1f3b06290846e7dcd7aceddabeceec8c. MIT. This native edition rebuilds twelve editable layouts; it is not an HTML import or an exact copy of every upstream slide.
...
Copyright (c) 2026 Zara Zhang. DSH adaptation 2026-09-06; Indigo Folio colorway variant 2026-09-13. Derived from the bundled Pesquisa minimalista template (MIT); see its design document for the pinned upstream source.
